...
public class ProveedorExamenTest {

	@Mock
	ProveedorExamen expected, actual;
	...
	public void setUp() throws Exception {
		...
		actual = new ProveedorExamen();
	}
	
	@Test
	public void testProveedorExamenIntStringStringStringString() {
		actual.setId(500);
