 ...
 * 2020-05-27T16:31:09.280-03:00
 * Generated source version: 3.3.3
 *
 */
@WebServiceClient(name = "RucafService",
                  wsdlLocation = "http://localhost/viruscontrol-wsdl/RucafService.wsdl",
...
public class RucafService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost/viruscontrol-wsdl/RucafService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RucafService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost/viruscontrol-wsdl/RucafService.wsdl");
        }
        WSDL_LOCATION = url;
    }
