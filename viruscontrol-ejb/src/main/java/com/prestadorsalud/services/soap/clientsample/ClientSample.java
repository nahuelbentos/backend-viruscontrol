package com.prestadorsalud.services.soap.clientsample;

import com.prestadorsalud.services.soap.*;
...
public class ClientSample {
	...
	public static void main(String[] args) {
	        ...
	        System.out.println("Server said: " + port1.obtenerPrestadorDeSaludAlternativo(Integer.parseInt(args[0])));
	        ...
	        System.out.println("Call Web Service Operation...");
	        System.out.println("Server said: " + port2.obtenerPrestadorDeSaludAlternativo(Integer.parseInt(args[4])));
