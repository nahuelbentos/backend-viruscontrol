 ...
 * 2020-05-31T21:08:18.296-03:00
 * Generated source version: 3.3.3
 *
 */
@WebServiceClient(name = "PerifericoPrestadoraSalud",
                  wsdlLocation = "http://localhost:8080/viruscontrol-web/openshift-wsdl/MiNubeGr14PerifericoPrestadoraSalud.wsdl",
...
public class PerifericoPrestadoraSalud extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/viruscontrol-web/openshift-wsdl/MiNubeGr14PerifericoPrestadoraSalud.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PerifericoPrestadoraSalud.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/viruscontrol-web/openshift-wsdl/MiNubeGr14PerifericoPrestadoraSalud.wsdl");
        }
        WSDL_LOCATION = url;
    }
