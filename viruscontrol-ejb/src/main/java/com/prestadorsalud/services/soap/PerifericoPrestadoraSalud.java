 ...
 * 2020-05-27T19:11:20.295-03:00
 * Generated source version: 3.3.3
 *
 */
@WebServiceClient(name = "PerifericoPrestadoraSalud",
                  wsdlLocation = "http://localhost:8080/prestadoras-salud/PerifericoPrestadoraSalud?wsdl",
...
public class PerifericoPrestadoraSalud extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/prestadoras-salud/PerifericoPrestadoraSalud?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PerifericoPrestadoraSalud.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/prestadoras-salud/PerifericoPrestadoraSalud?wsdl");
        }
        WSDL_LOCATION = url;
    }
