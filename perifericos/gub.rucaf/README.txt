...
a persistence unit "gub.rucafPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gub.rucaf\pom.xml":
...
artifact ("gub.rucaf.war") is already built. You can build
