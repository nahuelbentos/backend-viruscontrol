...
a persistence unit "com.prestadorsaludPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "com.prestadorsalud\pom.xml":
...
artifact ("com.prestadorsalud.war") is already built. You can build
