...
a persistence unit "com.examenPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "com.examen\pom.xml":
...
artifact ("com.examen.war") is already built. You can build
