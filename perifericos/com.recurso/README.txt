...
a persistence unit "com.recursoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "com.recurso\pom.xml":
...
artifact ("com.recurso.war") is already built. You can build
